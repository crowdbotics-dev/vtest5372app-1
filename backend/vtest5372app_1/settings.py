"""
Django settings for vtest5372app_1 project.
...
ROOT_URLCONF = 'vtest5372app_1.urls'
...
WSGI_APPLICATION = 'vtest5372app_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "vtest5372app Support <support@vtest5372app-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vtest5372app_1 API",
    "DESCRIPTION": "API documentation for vtest5372app_1 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "vtest5372app_1.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "vtest5372app_1.storage_backends.AzureStaticStorage"
